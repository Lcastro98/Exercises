...
## Sobre el Taller
Este repositorio cuenta con el desarrollo de 6 ejercicios prácticos en Java. Cada uno contenido en su propia carpeta.
...
## A tener en cuenta
Recuerde indicar cual es la clase con método main que desea ejecutar para ver cada uno de los ejercicios funcionando. Para ello puede utilizar el click derecho y seleccionar la opción Run File
