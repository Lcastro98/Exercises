...
public class Truck extends Vehicle {
    ...
    public Truck(float height, String plate, Calendar registrationDate, int passengers, boolean crew, int wheels, String meansTransport) {
